...
| [spec-writing](skills/spec-writing/) | Write clear human-facing requirements and architecture/solution documents, compare material implementation options, and keep discussion history in separate records. | Documentation, Requirements |
