...
| Live model runs | [2026-09-24 evaluation](audits/2026-09-24-live-evaluation.md): Claude Code 2.1.280, `claude-opus-5-5` through a gateway | Routing probes and bounded task outcomes at named revisions; uncontrolled cache accounting makes token budgets unreliable there. Not a certification of other models, hosts, or native discovery. |
