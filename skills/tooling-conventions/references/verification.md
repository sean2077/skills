...
Read this when choosing the minimal syntax, help, dry-run, manifest, and real-target checks.
...
bash <skill-dir>/scripts/manifest-check.sh <manifest>   # reconcile manifest vs disk
