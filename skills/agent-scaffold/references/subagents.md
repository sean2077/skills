...
The scaffold does not create or refresh those files or keys. `upgrade` only repairs exact legacy
commands that still point at `tools/agent/generate-subagents.py`; after migration they remain
project-owned.
