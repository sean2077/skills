"""Semantic contract for the `ai-slop-cleaner` catalog skill."""
...
REQUIRED_PATHS = ['SKILL.md', 'references/cleanup-safety.md']
REQUIRED_TEXT = ['Preserve behavior', 'Completion gate', 'verifier actually run', 'do not start a nested cleanup loop']
