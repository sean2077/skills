"""Semantic contract for the `analyze` catalog skill."""
...
SKILL = 'analyze'
REQUIRED_PATHS = ['SKILL.md', 'references/evidence-and-synthesis.md']
REQUIRED_TEXT = ['read-only', 'ranked synthesis', 'facts, inferences, and unknowns', 'Next read-only probe']
