"""Semantic contract for the `best-practice-research` catalog skill."""
...
REQUIRED_PATHS = ['SKILL.md', 'references/source-evaluation.md']
REQUIRED_TEXT = ['primary sources', 'repository-specific recommendation', 'Browse for current or niche facts']
