"""Semantic contract for the `code-review` catalog skill."""
...
SKILL = 'code-review'
REQUIRED_PATHS = ['SKILL.md', 'references/review-rubric.md']
REQUIRED_TEXT = ['Trigger', 'Impact', 'Evidence', 'Do not claim a bug without a plausible trigger']
