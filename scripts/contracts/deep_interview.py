...
REQUIRED_PATHS = ['SKILL.md', 'references/scoring-and-payloads.md', 'references/resume-and-recovery.md', 'scripts/interview_state.py']
REQUIRED_TEXT = ['interview_state.py', 'next_target', 'component_scores', 'active component', 'pending approval', 'Never hand-calculate ambiguity']
