...
REQUIRED_PATHS = ('SKILL.md', 'references/project-conventions.md', 'agent-scaffold.sh', 'scripts/harness-core.py', 'scripts/managed-assets.json', 'assets/scaffold/AGENTS.harness.md', 'assets/runtime/hooks/hook-paths.py')
