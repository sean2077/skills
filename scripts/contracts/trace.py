"""Semantic contract for the `trace` catalog skill."""
...
SKILL = 'trace'
REQUIRED_PATHS = ['SKILL.md', 'references/causal-evidence.md']
REQUIRED_TEXT = ['Entry gate', 'evidence for and against', 'Recommended discriminating probe', 'Read-only']
